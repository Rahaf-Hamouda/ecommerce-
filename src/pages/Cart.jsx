...
export default function Cart() {
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
        ...
        >
          ...
          <p className="text-gray-400 mb-10">Time to fill it with beautiful things ✨</p>
          <Link to="/products">
            <motion.button
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pt-28">
      ...
      >
        <div>
          <h1 className="font-display text-3xl md:text-4xl font-bold text-gray-900">Shopping Bag</h1>
            ...
            {items.map((item, index) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <Link
                    to={`/product/${item.id}`}
                    className="font-display font-semibold text-gray-800 hover:text-rose-500 transition-colors line-clamp-1"
                  >
                    {item.name}
                  </Link>
        ...
        <div className="lg:col-span-1">
          ...
          >
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="border-t border-rose-100 pt-4 flex justify-between">
