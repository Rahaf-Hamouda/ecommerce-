          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div>
              ...
              <div className="flex items-center gap-3 mt-6">
                <a href="#" className="p-2 rounded-full bg-white border border-rose-100 text-gray-400 hover:text-rose-500 hover:border-rose-200 transition-all hover:shadow-sm"><Instagram className="w-4 h-4" /></a>
                <a href="#" className="p-2 rounded-full bg-white border border-rose-100 text-gray-400 hover:text-rose-500 hover:border-rose-200 transition-all hover:shadow-sm"><Facebook className="w-4 h-4" /></a>
                <a href="#" className="p-2 rounded-full bg-white border border-rose-100 text-gray-400 hover:text-rose-500 hover:border-rose-200 transition-all hover:shadow-sm"><Twitter className="w-4 h-4" /></a>
                <a href="#" className="p-2 rounded-full bg-white border border-rose-100 text-gray-400 hover:text-rose-500 hover:border-rose-200 transition-all hover:shadow-sm"><Mail className="w-4 h-4" /></a>
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mb-4">Subscribe for exclusive offers, early access, and new arrivals.</p>
              <form onSubmit={handleSubscribe} className="space-y-2">
                ...
                {error && <motion.p initial={{ opacity: 0, y: -5 }} animate={{ opacity: 1, y: 0 }} className="text-xs text-rose-500 pl-4">{error}</motion.p>}
                <AnimatePresence>
                  {subscribed && <motion.p initial={{ opacity: 0, y: -5 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="text-xs text-emerald-600 pl-4">Thanks for subscribing! Check your inbox.</motion.p>}
                </AnimatePresence>
              </form>
            </div>
          </div>
